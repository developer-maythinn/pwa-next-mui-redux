...
export const client_id = process.env.OAUTH_CLIENT_ID;
export const client_secret = process.env.OAUTH_CLIENT_SECRET;
export const grant_type = process.env.OAUTH_GRANT_TYPE;
export const encryption_key = process.env.PWD_ENCRYPTION_KEY;
